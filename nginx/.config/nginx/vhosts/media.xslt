  ...
  <html>
	...
	<style type="text/css"><![CDATA[
		* { box-sizing: border-box; }
		...
		body { background-color: #303030; font-family: Verdana, Geneva, sans-serif; font-size: 24px; padding: 20px; margin: 0px; height: 100%; width: 100%; }

		table#contents td a { text-decoration: none; display: block; padding: 30px 30px 30px 30px; pointer: default; }
		table#contents { width: 100%; margin-left: auto; margin-right: auto; border-collapse: collapse; border-width: 0px; }
		...
		nav#breadcrumbs ul .icon { font-size: 24px; }
