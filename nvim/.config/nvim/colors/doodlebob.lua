...
do -- main
  ...
  do --vim relevant
    ...
    hi("StatusLine",   { fg = 9, bold = true, underline = true })
    hi("StatusLineNC", { fg = 8, bold = true, underline = true })
  ...
  do --quickfix
    hi("qfFileName",  { fg = 241 })
    hi("qfSeparator", { fg = 241 })
    hi("qfLineNr",    { fg = 241 })
  end
end
