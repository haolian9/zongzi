...
do --re-define builtin keymap
  ...
  m.i("<s-cr>", function() require("morecmds").insert_newline() end)
end
...
do --grep
  ...
  cmds.create("Todo", function() require("grep").text([[\btodo@?]]) end)
...
do --ido
  ...
  m.n("g0", function() require("ido").goto_truth() end)
