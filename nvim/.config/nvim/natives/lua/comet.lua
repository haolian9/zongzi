...
do
  ...
  function M.comment_curline()
    main(to_commented_line)
    repeats.remember_redo(0, M.comment_curline)
  end
  function M.uncomment_curline()
    main(to_uncommented_line)
    repeats.remember_redo(0, M.uncomment_curline)
  end
end
