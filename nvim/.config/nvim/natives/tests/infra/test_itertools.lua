...
local function test_2()
  local iter = itertools.filter(function(el) return el % 2 == 1 end, { 1, 2, 3, 4, 5 })
...
local function test_4()
  ...
  local it = itertools.mapn(function(a, b) return a + b end, source(5))
...
local function test_6()
  do
    ...
    local iter = itertools.project("a", list)
