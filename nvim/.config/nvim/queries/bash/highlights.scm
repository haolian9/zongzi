...
(command_name
  ...
  (#any-of? @function.builtin
    "alias" "bg" "bind" "builtin" "caller" "cd" "command" "compgen" "complete" "compopt"
    "coproc" "dirs" "disown" "echo" "enable" "eval" "exec" "fc" "fg" "getopts"
    "hash" "help" "history" "jobs" "kill" "let" "logout" "mapfile" "popd" "printf" "pushd" "pwd"
    "read" "readarray" "set" "shift" "shopt" "source" "suspend" "test" "time" "times"
    "trap" "type" "typeset" "ulimit" "umask" "unalias" "wait"))

(command_name
  (word) @keyword.return
  (#any-of? @keyword.return
    "return" "exit" "break" "continue" "exec" ))
