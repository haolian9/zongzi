 ...
 */
static char *font = "Monego Nerd Font Fix:pixelsize=20";
...
static const char *colorname[] = {
	...
	"#cccccc",
	"#555555",
	"#073642", /* default foreground colour */
	"#fdf6e3", /* default background colour */
	"#ef0b9e", /* default cursor color*/
};
...
static Key key[] = {
	...
	//
	// blesses from LeoNerd: https://matrix.to/#/!JAfPjWAdLCtgeCAwnS:matrix.org/$1665395868127350mxXKa:matrix.org?via=matrix.org&via=libera.chat&via=gitter.im
	// * if your terminal is sending CSIu encodings for Ctrl-Space and Ctrl-] that is probably the bit that wants fixing. It's best not to do that
	// * You may want to fix your terminal about Ctrl-space and Ctrl-] too. Leave them as their legacy C0 encodings
	// * You should only CSIu any key that is ambiguous and not "the usual key" that people type. which is why ctrl-i and ctrl-m but not the other letters.
	// * The one you quoted earlier, backslash, which -would- generate  CSI 92;5u  I would suggest not doing so because if you do that you've just broken the SIGQUIT key
	//
	// * shift, alt, ctrl, ctrl|shift: ;2u, ;3u, ;5u, ;6u
    // * XK_* the name is the same in `xmodmap -pke`
    // * but the codepoint is the same in `man ascii`, in decimal
	...
	{ XK_period,       Mod1Mask,              "\033[46;3u",  0, 0},
	...
	{ XK_H,            Mod1Mask|ShiftMask,    "\033[72;6u",  0, 0},
	{ XK_L,            Mod1Mask|ShiftMask,    "\033[76;6u",  0, 0},
	{ XK_K,            Mod1Mask|ShiftMask,    "\033[75;6u",  0, 0},
	{ XK_J,            Mod1Mask|ShiftMask,    "\033[74;6u",  0, 0},
